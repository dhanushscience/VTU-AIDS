              ...
              <div className="split-layout">
                ...
                <section className="hero-section">
                  ...
                  <div className="action-buttons">
                    <a 
                      href="https://github.com/dhanushscience/VTU-AIDS/releases/download/v2.1.1/VTU_AIDS_Setup.exe" 
                  ...
                  <div className="features-mini">
                    ...
                    <div className="feature-item">
                      ...
                      <div className="feature-text">
                        <h4>v2.1.1 — Secure &amp; up to date</h4>
                        <ul style={{ margin: '4px 0 0 16px', padding: 0, fontSize: '0.85rem', color: 'var(--text-light)' }}>
                          <li>Windows Credential Manager for secrets.</li>
                          <li>Supports new Gemini <code>AQ.</code> API keys.</li>
