              ...
              <div className="split-layout">
                ...
                <section className="hero-section">
                  ...
                  <div className="action-buttons">
                    <a 
                      href="https://github.com/dhanushscience/VTU-AIDS/releases/download/v2.1.0/VTU_AIDS_Setup.exe" 
                  ...
                  <div className="features-mini">
                    ...
                    <div className="feature-item">
                      ...
                      <div className="feature-text">
                        <h4>v2.1.0 Security Enhancements</h4>
                        <ul style={{ margin: '4px 0 0 16px', padding: 0, fontSize: '0.85rem', color: 'var(--text-light)' }}>
                          <li>Secure Windows Credential Manager integration.</li>
                          <li>Cross-Origin (CORS) & CSRF protections.</li>
                          <li>Rate limiting & strict input validation.</li>
                        </ul>
                      </div>
                    </div>
                  </div>
