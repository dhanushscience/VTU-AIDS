...
|------|----------------|-------|
| [VTU_AIDS_Setup.exe](https://github.com/dhanushscience/VTU-AIDS/releases/download/v1.0.5/VTU_AIDS_Setup.exe) | ~483 MB | Recommended - includes Chromium for automation |
