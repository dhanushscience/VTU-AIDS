...
This is a practical, beginner-friendly setup guide for release **v2.1.1**.
...
Download: [VTU_AIDS_Setup.exe](https://github.com/dhanushscience/VTU-AIDS/releases/download/v2.1.1/VTU_AIDS_Setup.exe)  
...
| App did not open automatically after install | Normal in v2.1.1. Open from Start menu manually. |
